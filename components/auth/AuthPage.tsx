...
import { ExclamationTriangleIcon, CheckCircleIcon, ArrowLeftIcon, ArrowRightIcon, CpuChipIcon, MicrophoneIcon, UserGroupIcon } from '@heroicons/react/24/solid';
                ...
                {step === 'email' ? (
                    <div className="space-y-8">
                        <div>
                            ...
                            <p className="text-gray-400">Enter your email to continue to Bubble.</p>
                        </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div>
                            <h2 className="text-3xl font-bold text-white mb-2">{isSignUp ? 'Create Account' : 'Enter Password'}</h2>
                            <p className="text-gray-400">
                                {isSignUp ? 'Set a password for your new account.' : `Welcome back, ${email}`}
                            </p>
                        </div>
                ...
                <AnimatePresence>
                    ...
                    {authSuccess && (
                        <motion.div 
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            exit={{ opacity: 0 }}
                            className="mt-6 p-4 bg-green-500/10 border border-green-500/20 rounded-xl flex items-center gap-3 text-green-300"
                        >
